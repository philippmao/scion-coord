...
func (s *SCIONBoxController) parseRequest(r *http.Request) (isNAT bool, inernal_ip string, external_ip string,
		mac_address string, openPorts int, startPort int, err error) {
